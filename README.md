...
| `API_BASE_URL` | Gemini API 的自定义基础 URL。点击[此处](https://github.com/babaohuang/GeminiProChat?tab=readme-ov-file#关于-api-使用过程中-user-location-is-not-supported-for-the-api-use-的解决方案)查看何时使用。| ❌ |
